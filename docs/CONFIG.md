...
| MH_HOSTNAME         | -hostname       | localhost:10018 | Hostname to use for EHLO/HELO and message IDs
...
| MH_SMTP_BIND_ADDR   | -smtp-bind-addr | localhost:1025    | Interface and port for SMTP server to bind to
